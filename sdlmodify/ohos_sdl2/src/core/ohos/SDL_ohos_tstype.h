...
enum NapiCallBackType {
    ...
    NAPI_CALLBACK_ADD_CHILD_NODE,
    NAPI_CALLBACK_REMOVE_CHILD_NODE,
    NAPI_CALLBACK_RESIZE_NODE,
    NAPI_CALLBACK_MOVE_NODE,
    NAPI_CALLBACK_SHOW_NODE,
    NAPI_CALLBACK_HIDE_NODE,
    NAPI_CALLBACK_RAISE_NODE,
